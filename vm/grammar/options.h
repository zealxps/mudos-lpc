...
/* ARGUMENTS_IN_TRACEBACK: prints out fun call arguments in error
 *   tracebacks, to aid in debugging.  Note: it prints the values of
 *   the arguments at the time of the error, not when the fun
 ...
 *   this adds three long ints (12 bytes on 32-bit machines) to the fun
