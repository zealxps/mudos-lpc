...
unsigned int set_object_type(object_t *obj, unsigned int type);

unsigned int get_object_type(object_t *obj);

svalue_t *call_script_func(const char *object_name,const char *name,const char *fmt, ...);
