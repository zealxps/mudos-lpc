	...
	typedef struct array_s
	{
		...
		/*
		// iterator op
		void *(*iter_head)(struct fs_iterator_s *iter, struct array_s *arr);
		void *(*iter_next)(struct fs_iterator_s *iter, struct array_s *arr);
		void *(*iter_info)(struct fs_iterator_s *iter, struct array_s *arr);
		struct fs_iterator_s *(*iter_erase)(struct fs_iterator_s *iter, struct array_s *arr);
		*/
