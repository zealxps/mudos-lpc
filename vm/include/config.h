...
// 1 << 20 1048576
// 需要结合考虑MAX_TABLE_SIZE
#define MAX_MAPPING_SIZE   (1<<17)
#define MAX_ARRAY_SIZE     (1<<17)
#define MAX_MAPPING_WARNING_SIZE  (60000)
...
// hard code 死以下参数
#define INCLUDE_DIRS       "/include:/qn/include"
...
#endif // NETD_MODULE
*/
#define QTZ_ServerEngine_LIB  "./world"

extern char game_lib_bin_path[];
#define BIN_DIR              (game_lib_bin_path)

// 以下参数尽量由脚本提供
#define QTZ_ServerEngine_NAME "xlhx"
// TODO:确认下包大小
