...
/*
 * List files in directory. This fun do same as standard list_files did,
 ...
 * of strings, the fun will return an array of arrays about files.
 ...
 * message somewhere.
 */
void smart_log(char *error_file, int line,const char *what, int flag)
{
	char *buff;
	svalue_t *mret;
	extern int pragmas;
