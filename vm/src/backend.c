...
void logon(object_t *ob)
{
	...
	/* fun not existing is no longer fatal */
}
 ...
 * list before we call its fun, and always using the item at the head
 * of the list as our fun to call.  We keep calling heart beats until
